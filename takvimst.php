...
// Örnek etkinlik verileri (Öğrenciye özel)
$events = [
    [
        'id' => 1,
        'title' => 'Vize Sınavı',
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="takvimst.php" class="nav-item active">
    ...
    <div class="main-content">
        <div class="header">
            <h1 class="page-title">Akademik Takvim</h1>
            
            <div class="user-menu">
                <div class="user-info">
                    <div class="user-name"><?= htmlspecialchars($_SESSION['user']['name'] ?? 'Öğrenci') ?></div>
    ...
    <script>
        ...
        function getEventColor(type) {
            switch(type) {
                ...
                case 'lecture': return 'var(--success)';
        ...
        function getEventBorderColor(type) {
            switch(type) {
                ...
                case 'lecture': return 'darken(var(--success), 10%)';
